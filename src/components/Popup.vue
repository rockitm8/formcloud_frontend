        ...
        <form id="myform">
          <div class="content-box">
            <div class="box">
              ...
              <button type="button" @click="checkPresetForm" class="sub-btn">
                Save Preset
              </button>
            </div>
          </div>
...
export default {
  ...
  methods: {
    ...
    validateInputs() {
      ...
      const firstname = document.getElementById('preset_firstname');
      const lastname = document.getElementById('preset_lastname');
      const email = document.getElementById('preset_email');
      const subject = document.getElementById('preset_subject');
      const phonenumber = document.getElementById('preset_phonenumber');
      const company = document.getElementById('preset_company');
      const department = document.getElementById('preset_department');
      const address = document.getElementById('preset_address');
